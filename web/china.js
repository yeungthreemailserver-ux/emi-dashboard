...
const TT = {
  ...
  sub_ind2: ["China's position across the electronic-component supply chain", "中国在电子元器件供应链中的地位"],
  lev_hold: ["Where China dominates", "中国主导的环节"],
  lev_hold_cap: ["· the commodity layer — sourcing concentration", "· 大宗/通用层 — 采购集中度"],
  lev_gap: ["Where China is locked out", "中国受制的环节"],
  lev_gap_cap: ["· high-value franchises stay with US / EU / JP / KR / TW incumbents", "· 高价值产品线仍由美/欧/日/韩/台巨头掌握"],
  lev_take: ["China now leads the commodity layer a distributor sources — chip materials, LEDs, displays and PCBs — and is closing fast on mature-node (legacy) chips (~30% and rising). But the high-margin franchises — leading-edge logic, HBM, FPGAs, auto/industrial MCUs and high-end analog, power & MLCC — still come from US, European, Japanese, Korean & Taiwanese incumbents.",
             "中国已主导分销商采购的大宗层 — 芯片材料、LED、面板与 PCB,并在成熟制程(传统)芯片上快速逼近(约 30% 且持续上升)。但高利润产品线 — 先进逻辑、HBM、FPGA、车规/工业 MCU 与高端模拟/电源/MLCC — 仍来自美、欧、日、韩、台巨头。"],
